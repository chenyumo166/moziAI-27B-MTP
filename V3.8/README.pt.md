...
| Item | Especificação |
| --- | --- |
| Modelo base | Qwen3.8-27B (arquitetura Dense, atenção híbrida 16 full + 48 linear, licença Apache-2.0) |
