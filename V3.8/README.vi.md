...
| Mục | Thông số |
| --- | --- |
| Mô hình nền tảng | Qwen3.8-27B (kiến trúc Dense, chú ý lai 16 full + 48 linear, giấy phép Apache-2.0) |
...
Xem tệp [LICENSE.md](../LICENSE.md) để biết điều khoản đầy đủ.
