...
```
V3.8/
├── moziAI-27B-3.8-Q4_K_M-Qwen3.8-27B.gguf   ← Hauptmodell (erforderlich, 13,7 GB)
├── moziAI-27B-3.8-mmproj-F16.gguf            ← visuelles Projektionsmodul (erforderlich, 927 MB)
└── chat-template-moziai-27B-v38.jinja         ← Chat-Template (erforderlich, enthält siebendimensionale Denk- und Loop-Anweisungen)
```
