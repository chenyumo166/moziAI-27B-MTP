...
독자 개발한 MoziSmartBit 지능형 양자화 기술로 270억 파라미터 Dense 모델을 약 13.7 GB로 압축. 일반 Q4_K_M 양자화(~17GB) 대비 3.3GB(약 20%) 작아지며, 정밀도와 크기의 최적 균형을 달성. FP16의 **약 99% 정밀도 품질**을 유지합니다.
...
- **MoziSmartBit 지능형 양자화**: 독자 양자화 기술, 약 **13.7 GB** 압축, **약 99%** 정밀도 유지
- **소비자 GPU 배포**: 20GB VRAM 이상 배포 가능, 256K 긴 컨텍스트 지원
...
| 모델 크기 | ~13.7 GB |
| 최소 VRAM | 20GB+ (RTX 4060 Ti 16G은 CPU 오프로드 필요) |
...
| **MoziSmartBit** | **~13.7 GB** | **약 99%** | **독자 지능형 양자화** |
